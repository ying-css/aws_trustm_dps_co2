...
SOURCES+=\
	...
	$(CY_AFR_ROOT)/demos/iot_smart_sensor/dps310_pressure_sensor/iot_smart_sensor_dps310.c\
	$(CY_AFR_ROOT)/demos/arise_corner/arise_corner_demo_mqtt.c\
	$(CY_AFR_ROOT)/demos/arise_corner/sensor_xensiv_pasco2/pasco2_demo.c
...
INCLUDES+=\
	...
	$(CY_AFR_ROOT)/demos/iot_smart_sensor\
	$(CY_AFR_ROOT)/demos/iot_smart_sensor/dps310_pressure_sensor\
	$(CY_AFR_ROOT)/demos/arise_corner/sensor_xensiv_pasco2

################################################################################
# libraries (sensor/actuator libraries)
################################################################################

# DPS 310 pressure/temperature sensor library source files
SOURCES+=\
...
# xensiv pasco2 sensor library source files
#SOURCES+=\
	$(CY_AFR_ROOT)/libraries/sensor-xensiv-pasco2/COMPONENT_SOFTFP/TOOLCHAIN_GCC_ARM/libpasco2.a
	
INCLUDES+=\
	$(CY_AFR_ROOT)/libraries/sensor-xensiv-pasco2
